...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.customer.products.index', ['products' => Product::getByStatus($this->search, $this->status)->orderBy($this->sortField, $this->sortDirection)->paginate($this->productsPerPage)]);
    }
