                                ...
                                <div class="flex justify-end">
                                    ...
                                    @else
                                        ...
                                        <a href="{{ route('users.edit', $user->id) }}"
                                            ...
                                            <button class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" wire:click="$emit('openModal', 'user.delete-user', {{ json_encode(['user' => $user]) }})">Eliminar usuario</button>
                                    @endif
                                </div>
                            </x-table.cell>
                        </tr>
