...
class GuestProducts extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.guest-products', ['products' => Product::getByStatus($this->search, $this->status)->orderBy($this->sortField, $this->sortDirection)->paginate($this->productsPerPage)]);
    }
